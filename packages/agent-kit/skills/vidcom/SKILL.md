...
4. Route project setup to `/vidcom-project`, scene edits to `/vidcom-scene`, animation to `/vidcom-motion`, look changes to `/vidcom-look`, speech to `/vidcom-narration`, output to `/vidcom-render`, and failures to `/vidcom-fix`.
