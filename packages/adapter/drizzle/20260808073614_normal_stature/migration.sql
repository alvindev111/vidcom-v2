...
CREATE TABLE `__new_workspace_operation` (
	...
	CONSTRAINT "ck_workspace_operation_kind" CHECK("kind" IN ('agent_kit_files', 'project_create', 'project_rename', 'project_delete', 'project_import')),
...
INSERT INTO `__new_workspace_operation`(`id`, `workspace_root`, `kind`, `project_id`, `from_path`, `to_path`, `staging_path`, `backup_id`, `grant_id`, `status`, `actor`, `action`, `tool_audit_json`, `created_at`, `settled_at`) SELECT `id`, `workspace_root`, `kind`, `project_id`, `from_path`, `to_path`, `staging_path`, `backup_id`, `grant_id`, `status`, `actor`, `action`, `tool_audit_json`, `created_at`, `settled_at` FROM `workspace_operation`;--> statement-breakpoint
