...
> **Đính chính số lượng:** phụ lục hiện có **66 correction**. Đoạn tổng kết lịch sử ngay dưới đây mô tả C-1–C-52; C-53–C-66 cũng không mở rộng requirement, mà reconcile capability đã có với packaging/daemon/MCP contract và exact-HEAD evidence gate. Đoạn tổng kết lịch sử ngay sau đây vẫn mô tả chi tiết đến C-65; C-66 giữ nguyên nguyên tắc bounded deadline/no mutation retry đó.
