...
> **Đính chính số lượng:** phụ lục hiện có **69 correction**. Đoạn tổng kết lịch sử ngay dưới đây giữ nguyên câu đếm cũ tới C-68; C-69 cũng không mở rộng requirement mà sửa một false-negative của harness theo đúng MCP stdout/stderr contract.
