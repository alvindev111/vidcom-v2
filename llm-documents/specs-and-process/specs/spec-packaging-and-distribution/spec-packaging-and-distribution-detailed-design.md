...
> **Đính chính số lượng:** phụ lục hiện có **68 correction**. Đoạn tổng kết lịch sử ngay dưới đây mô tả C-1–C-52; C-53–C-68 cũng không mở rộng requirement, mà reconcile capability đã có với packaging/daemon/MCP contract và exact-HEAD evidence gate.
