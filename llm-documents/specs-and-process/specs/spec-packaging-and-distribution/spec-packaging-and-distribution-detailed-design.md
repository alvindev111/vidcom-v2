...
> **Đính chính số lượng:** phụ lục hiện có **71 correction**. Đoạn tổng kết lịch sử ngay dưới đây giữ nguyên câu đếm cũ tới C-68; C-69–C-71 cũng không mở rộng requirement mà sửa false-negative của MCP stderr, full-suite test budget, và việc C-21 chưa có đường thực thi.
