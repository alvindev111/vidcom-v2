...
> Bản 2 vẫn **APPROVED**. Phụ lục này không mở lại phạm vi, không thêm/bớt requirement và **không đổi ước lượng 177 SP**. Nó sửa hai mươi tám chỗ mà bản 2 nói khác code, manifest authority hoặc hành vi runtime đã đo, phát hiện khi review và thực thi Implementation Checklist. Mỗi món nêu bằng chứng đã kiểm để không phải kiểm lại.
