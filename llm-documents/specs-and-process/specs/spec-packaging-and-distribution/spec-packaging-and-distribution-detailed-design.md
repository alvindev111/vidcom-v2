...
> **Đính chính số lượng:** phụ lục hiện có **70 correction**. Đoạn tổng kết lịch sử ngay dưới đây giữ nguyên câu đếm cũ tới C-68; C-69–C-70 cũng không mở rộng requirement mà sửa false-negative của MCP stderr và full-suite test budget.
